...
namespace BaseDatosProyecto.vista.Botones_Personalizados
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.CalendarioBlanco;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Properties.Resources.CalendarioNegro;
                else calendarIcon = Properties.Resources.CalendarioBlanco;
                this.Invalidate();
            }
        }
